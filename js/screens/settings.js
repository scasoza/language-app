        ...
        try {
            ...
            <main class="flex-1 overflow-y-auto pb-10">
                ...
                <div class="px-4 mb-6">
                    <div class="bg-gradient-to-r ${apiConfigured ? 'from-primary to-emerald-400' : 'from-amber-500 to-orange-500'} p-4 rounded-xl shadow-lg flex items-center justify-between text-background-dark">
                        <div class="flex flex-col">
                            ...
                            <span class="text-sm font-medium opacity-80">${apiConfigured ? 'Gemini features enabled' : 'Enable advanced features'}</span>
                        </div>
                ...
                <div class="mt-8 text-center">
                    ...
                    <p class="text-xs text-slate-400 dark:text-slate-600">Powered by Gemini</p>
                </div>
            </main>
        `;
        } catch (error) {
