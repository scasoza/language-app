 ...
 * - Collection creation with Gemini 2.0 Flash (multimodal)
...
const GeminiService = {
    ...
    // Model IDs
    MODELS: {
        FLASH: 'gemini-2.0-flash', // For text/multimodal generation
    ...
    /**
     * Generate flashcards from text/image using Gemini 2.0 Flash
...
[
  {
    ...
    /**
     * Generate a collection based on topic/image using Gemini 2.0 Flash
...
Format:
{
  ...
  "cards": [
    ...
    /**
     * Generate a dialogue for language practice using Gemini 2.0 Flash
...
Respond ONLY with valid JSON:
{
  ...
  "lines": [
    ...
    /**
     * Generate audio for dialogue using Gemini 2.5 Flash TTS
